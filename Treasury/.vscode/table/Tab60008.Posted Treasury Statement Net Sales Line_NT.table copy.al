table 60008 "Posted Treas. NetSalesLine_NT"
{
    DataClassification = CustomerContent;
    Caption = 'Posted Treas. Stmt. Net Sales Line';
    ...
    fields
    {
        ...
        field(70; "Store Hierarchy No."; Code[10])
        {
            ...
            TableRelation = "Posted Treasury Statement_NT"."Store Hierarchy No." where("Store Hierarchy No." = field("Store Hierarchy No."));
            trigger OnValidate()
            begin
            end;
        }
