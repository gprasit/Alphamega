...
function InitializeControl(controlId) {
    ...
    controlAddIn.innerHTML ='<div id="pdf-contents"><div id="pdf-meta"><div id="pdf-buttons"><button id="prev"><span class="bi bi-arrow-left-circle-fill" style="font-size:1.5rem;color:#00b7c3" data-toggle="tooltip" title="Previous"></span></button><button id="next"><span class="bi bi-arrow-right-circle-fill" style="font-size:1.5rem;color: #00b7c3" data-toggle="tooltip" title="Next"></span></button><button id="pdf-view"<span class="bi bi-eye-fill" style="font-size:1.5rem;color: #00b7c3" data-toggle="tooltip" title="View"></span></button></div><span id="page-count-container">Page: <span id="page_num"></span> / <span id="page_count"></span></span></div><canvas id="the-canvas"></canvas></div>';
}
