Report 60401 "Transaction Invoice_NT"
{
    DefaultLayout = RDLC;
    ...
    trigger OnPreReport()
    var
        Addr4Label: Label 'Phone: (357) %1   Fax: (357) %2';
        Addr5Label: label 'VAT Registration No: %1';
    begin
        CompanyInfo.Get;
       ...
       */
        Address[1] := CompanyInfo.Address;
        Address[2] := CompanyInfo."Address 2";
        Address[3] := CompanyInfo."Home Page";
        address[4] := StrSubstNo(Addr4Label, CompanyInfo."Phone No.", CompanyInfo."Fax No.");
        address[5] := StrSubstNo(Addr5Label, CompanyInfo."VAT Registration No.");
        //BC Upgrade End
    end;
