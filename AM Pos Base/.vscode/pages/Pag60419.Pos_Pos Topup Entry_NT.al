page 60419 "Pos_Pos Topup Entry_NT"
{
    ApplicationArea = All;
    Caption = 'Pos Topup Entry';
    PageType = List;
    SourceTable = "Pos_Pos Topup Entry_NT";
    UsageCategory = Lists;
    Editable = false;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("Trans. Line No."; Rec."Pos Trans. Line No.")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Pos Trans. Line No. field.';
                }
